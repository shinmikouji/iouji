    ...
    <div class="c-inner">
      ...
      <div class="p-info-iouji" id="raireki">
        ...
        <p class="p-info-iouji__text">
          当寺は国宝山甘露院医王寺といい、本尊は薬師如来で開基は宝永年間 に当地の一村民によって開創されたと伝えられています。<br />
        ...
        <ul>
          <li>
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/images/info/info-01.jpg" alt="玉川三十四観音霊場第23 番札所関東九十一薬師霊場第２番札所の画像">
          </li>
          <li>
            <div>
              <h3>聖觀世音菩薩</h3>
          ...
          <li>
            <div>
              <h3>七地蔵</h3>
              <p>
                一般的にお寺の山門前や墓地前に六地蔵が安置されま す。 このお寺、この墓地に眠る全ての人をお救いいた だくためです。 地獄道から穏やかな天道まであります が、どの世界であっても救っていただけるという願いを込めお参りするのです。 当寺ではこの六地蔵の中心に「延命地蔵」がございます。皆様が救われ健康長寿となることを願うものです。山門をくぐる前に、まず七地蔵に手を合わせ日々安穏をお願いしてください。
              </p>
            </div>
